...
public interface StudentUtil_613 {
    ...
    // 70 <= 평균점수 <= 79 : "C"등급
    // 70 > 평균점수  : "D"등급
    String getGradeByStudentName(Student_613[] students, String name);

    //--두번째 메서드--
    //메서드명 : getTotalScoresToArray
    //매개변수로 받은 다수의 학생들의 총점을 배열로 리턴
    int[] getTotalScoresToArray(Student_613[] students);
    ...
    Student_613 getHighScoreStudent(Student_613 sut1, Student_613 stu2);
}
