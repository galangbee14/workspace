...
public class Account_610_n {
    String accNumber;
    String owner;
    int money; //예금액

    public Account_610_n(){
        accNumber = "미정";
        owner = "미정";
        money = 10000;
    }

    //매소드 오버로딩인 경우에만 생성자 여러개 만들 수 있음 (매개변수,매개변수개수 다른경우)
    public Account_610_n(int a){
        money = a;
    }
...
//    }
    ...
    public void setAccount(String accNumber, String owner, int money){
        //this가 붙으면, 이 클래스에서 선언한 accNumber
